; rbcp_config.s — RBCP configuration for the Apple IIe reliability meter
; Copyright (C) 2026 Piers Finlayson <piers@piers.rocks>
;
; An 8KB image in the IIe's EF socket, $E000-$FFFF, which is the one holding
; the reset vector.  A II or II+ has a 2KB F8 socket instead, and the meter
...
; meter runs has been copied to RAM before the session starts.  It falls in
...
; meter reads is a device name, which is 24 bytes and a terminator.
