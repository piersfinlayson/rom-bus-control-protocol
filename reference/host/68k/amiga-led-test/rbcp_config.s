; rbcp_config.s — RBCP configuration for the Amiga LED tester
...
; attempts.
;
; One retry, because a key press that does nothing reads as a tester that is
; broken.  A command the retry does not save goes to the recovery, and the
...
CONFIG_RBCP_AUX_POLL_TIMEOUT EQU $00FFFFFF      ; no SET_AUX is sent, so this
