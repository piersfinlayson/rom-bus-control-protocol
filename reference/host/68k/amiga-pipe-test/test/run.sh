#!/bin/sh
# run.sh — runs the built tester on an emulated Amiga 500 against a fake RBCP
# device with a pipe.  See README.md in this directory.
#
...
#
# Nothing is sent until somebody starts a run, so this presses RETURN partway
