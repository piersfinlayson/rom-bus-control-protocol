...
The 6502 and 8088 implementations have the simplest possible relationship to the protocol: the ROM is eight bits wide, the CPU bus is eight bits wide, and a byte offset in the device's slot is a byte offset in the CPU's address space.
