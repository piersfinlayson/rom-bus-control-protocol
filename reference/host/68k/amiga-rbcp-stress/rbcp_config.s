; rbcp_config.s — RBCP configuration for the Amiga reliability meter
...
;
; CONFIG_RBCP_TIMEOUT_RETRIES is zero.  A retry hides the failure this program
; exists to count.
; ---------------------------------------------------------------------------
...
; transposition.  The longest thing the meter reads is a 24-byte device name,
; so 48 bytes is twice what it needs.  It sits in the application
